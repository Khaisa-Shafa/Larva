...
class AedesCategoryAdapter: RecyclerView.Adapter<AedesCategoryAdapter.AedesCategoryViewHolder>() {

    private val favoriteIds = mutableSetOf<String>()

    inner class AedesCategoryViewHolder(private val binding: NewsItemBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(news: News) {
            binding.apply {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AedesCategoryViewHolder {
        return AedesCategoryViewHolder(
    ...
    override fun onBindViewHolder(holder: AedesCategoryViewHolder, position: Int) {
