...
class AnophelesCategoryAdapter: RecyclerView.Adapter<AnophelesCategoryAdapter.AnotherCategoryViewHolder>() {
    ...
    inner class AnotherCategoryViewHolder(private val binding: NewsItemBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(news: News) {
            binding.apply {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AnotherCategoryViewHolder {
        return AnotherCategoryViewHolder(
    ...
    override fun onBindViewHolder(holder: AnotherCategoryViewHolder, position: Int) {
